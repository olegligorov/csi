...
class ImageServiceImplTest {
    ...
    void testGetImageTagsWithCachedImageReturnsCachedImage() {
        ...
        Image cachedImage = new Image(imageUrl, "checksum", "imagePath", imageTaggerServiceEntity, new HashMap<>(), 800, 600);
    ...
    void getImageTagsWithoutCacheReturnsNewlyCreatedImage() throws IOException {
        ...
        Image savedImage = new Image(imageUrl, "checksum", "imagePath", imageTaggerServiceEntity, new HashMap<>(), 1280, 850);
    ...
    void testGetImageByIdOfAnExistingImage() {
        Long imageId = 1L;
        Image expectedImage = new Image("https://docs.imagga.com/static/images/docs/sample/japan-605234_1280.jpg", "checksum", "imagePath", imageTaggerServiceEntity, new HashMap<>(), 1280, 850);
