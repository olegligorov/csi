...
import com.imageclassification.models.ImageTag;
...
//        Check if the image is already in the database
        ...
        Image createdImage = imageRepository.save(new Image(imageUrl, imageTaggerServiceName, imageTags, imageWidth, imageHeight));
